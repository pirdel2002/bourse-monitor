...
export function buildIndicatorAnalysis(history,liveRow=null){
  ...
  const context={
    ...
    return_5d:round(rollingReturn(5)),return_20d:round(rollingReturn(20)),high_10:round(priorHigh(10)),low_10:round(priorLow(10)),high_20:round(priorHigh(20)),low_20:round(priorLow(20)),close_prev5:candles.length>5?round(candles.at(-6).close):null,
