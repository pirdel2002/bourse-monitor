...
export function buildIndicatorAnalysis(history,liveRow=null){
  ...
  const context={
    ...
    ema20:round(ema20),ema20_prev1:round(ema20Prev),ema50:round(ema50),ema20_ema50_gap_pct:round(finite(ema20)&&finite(ema50)&&ema50!==0?Math.abs(ema20-ema50)/ema50*100:null),rsi14:round(rsi14),
    ...
    mfi14:round(mfi14),obv:round(obvNow,0),obv_prev1:round(lastFinite(obv,1),0),obv_prev2:round(lastFinite(obv,2),0),obv_high_5:round(high(5),0),obv_high_10:round(high(10),0),obv_high_20:round(high(20),0),obv_low_10:obv.length>10?round(Math.min(...obv.slice(-11,-1)),0):null,
    ...
    return_5d:round(rollingReturn(5)),return_20d:round(rollingReturn(20)),high_20:round(priorHigh(20)),low_20:round(priorLow(20)),
