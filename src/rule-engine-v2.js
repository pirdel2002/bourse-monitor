...
export const conditionCatalogV2=[
  'PRICE_ABOVE','PRICE_BELOW','PRICE_CROSS_ABOVE','PRICE_CROSS_BELOW','PRICE_IN_RANGE','PRICE_HOLD_ABOVE','CLOSE_ABOVE','CLOSE_AT_OR_BELOW','EMA_RECLAIM_20','EMA_RECLAIM_50','EMA20_ABOVE_EMA50','EMA20_50_GAP_BELOW',
...
const valueConditions=new Set(['PRICE_ABOVE','PRICE_BELOW','PRICE_CROSS_ABOVE','PRICE_CROSS_BELOW','CLOSE_ABOVE','CLOSE_AT_OR_BELOW','EMA20_50_GAP_BELOW','RSI_ABOVE','RSI_BELOW','RSI_CROSS_ABOVE','RSI_CROSS_BELOW','MFI_ABOVE','MFI_BELOW','MFI_CROSS_ABOVE','MFI_CROSS_BELOW','VOLUME_RATIO_ABOVE','BUYER_POWER_ABOVE','BUYER_POWER_BELOW','BBW_BELOW','PROFIT_ABOVE','LOSS_BELOW','TRAILING_STOP','MARKET_BREADTH_STRONG','MARKET_BREADTH_WEAK','MARKET_BUYER_POWER_STRONG','MARKET_BUYER_POWER_WEAK','MARKET_VOLUME_HIGH','BUY_QUEUE_VALUE_CHANGE_15M_ABOVE','SELL_QUEUE_VALUE_CHANGE_15M_ABOVE']);
...
export function evaluateCondition(condition,context){
  ...
  switch(condition.name){
    ...
    case 'CLOSE_ABOVE':case 'CLOSE_AT_OR_BELOW':if((missing=numeric('قیمت پایانی',c.close)))return missing;{const above=condition.name==='CLOSE_ABOVE';return result(above?c.close>p.value:c.close<=p.value,`قیمت پایانی ${fa(c.close)} ${above?'>':'≤'} ${fa(p.value)}`);}
